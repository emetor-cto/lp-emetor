...
export function WhatsAppButton() {
  const phone = "5541998243692"
  const message = "Olá! Vim pelo site da Emetor e gostaria de tirar algumas dúvidas sobre sistemas sob medida e diagnóstico."
  ...
  return (
    <motion.a
      ...
      aria-label="Falar no WhatsApp com a Emetor"
